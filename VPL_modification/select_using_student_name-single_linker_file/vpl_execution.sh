...
for i in $ALL_QUESTIONS ; do
	...
	THIS_QUESTION_OUTFILE=$( output_file_func $THIS_QUESTION_KEY )
	...
	THIS_QUESTION_EXECUTABLE=$( test_file_func $THIS_QUESTION_KEY )
	THIS_QUESTION_CASES_FILE=$( cases_file_func $THIS_QUESTION_KEY )
	...
	if [ -f $THIS_QUESTION_EXECUTABLE ] ; then
		...
		mv $THIS_QUESTION_EXECUTABLE vpl_test
		mv $THIS_QUESTION_CASES_FILE evaluate.cases
	...
	# echo ">Peso: $SCALE" >> $BUFFER_FILE
 	echo ">Avaliação: $THIS_QUESTION_GRADE/$THIS_QUESTION_WEIGHT" >> $BUFFER_FILE
