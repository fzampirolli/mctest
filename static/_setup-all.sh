...
apt install python3 python3-dev idle-python3.6
...
python manage.py runserver $DB_HOST:8000
...
# mysql -u root -p $DB_NAME < "mctest.sql"
...
>> cat runDjango.sh
python manage.py runserver 177.104.60.16:8000
